-- =====================================================================
-- MOTOR v3 — design JSON nas mensagens (editor visual) e segmentos v2
-- com múltiplas condições combinadas por E/OU.
-- Formato v2 da definicao:
--   { "op": "and"|"or", "condicoes": [
--       {"campo":"lista","lista_id":17,"status":1,"tem":true},
--       {"campo":"tag","tag_id":65,"tem":false},
--       {"campo":"whatsapp","tem":true},
--       {"campo":"busca","valor":"maria"},
--       {"campo":"email_dominio","valor":"gmail.com"},
--       {"campo":"participacao","valor":"CASA_H_2026","tem":true},
--       {"campo":"atributo","chave":"Cidade","valor":"Brasília"},
--       {"campo":"abriu_email","dias":30,"tem":true},
--       {"campo":"clicou_email","dias":30,"tem":true},
--       {"campo":"nao_suprimido"} ] }
-- O formato v1 (filtros rápidos) continua aceito.
-- =====================================================================
begin;
