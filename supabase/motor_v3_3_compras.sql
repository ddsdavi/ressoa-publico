-- MOTOR v3.3 — compras como condição de segmento.
-- Sem isto não havia jeito nenhum de segmentar por quem comprou,
-- quantas vezes, quanto gastou ou quem pediu reembolso.
