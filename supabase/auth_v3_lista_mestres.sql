...
alter table public.usuarios_ressoa disable trigger trg_protege_admin_mestre;

update public.usuarios_ressoa u
...
alter table public.usuarios_ressoa enable trigger trg_protege_admin_mestre;

commit;

select email, papel, status, admin_mestre from public.usuarios_ressoa order by created_at;
