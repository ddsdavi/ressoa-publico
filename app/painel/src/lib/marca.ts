...
// entrando aqui também: o painel passou a se apresentar como "Ressoa · Nome
// do Remetente" em produção, com cara de campo esquecido.
//
// Sem as variáveis o painel se apresenta só como Ressoa. É o que qualquer
...
export const TITULO = MARCA_NOME ? `Ressoa · ${MARCA_NOME}` : "Ressoa";
